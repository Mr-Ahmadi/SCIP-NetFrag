...
def run_pct_2cluster():
    ...
    for modelSolve in models:
        ...
        numPackets2 = []
        RuntimeTotal2 = []
        errorRuntime = []     # per percentage list of [rt per ittr]
        errorPackets = []     # per percentage list of [pkts per ittr]
        for percentage in Percentages:
            errorRuntime.append([])
            errorPackets.append([])
            envTemp = env_2c_10sw_6f
    ...
    plot_single_bars(x_labels, pkt_series,
                     YLEN_FRAG, XLEN_RHO,
                     "plots/percentage_2cluster_fragments.pdf",
    ...
    run.save("plots/pct_2cluster_data.json", extra={"summary": summary,
                                                    "plot_files": [
        "plots/percentage_2cluster_fragments.pdf",
        "plots/percentage_2cluster_runtime.pdf",
    ]})
