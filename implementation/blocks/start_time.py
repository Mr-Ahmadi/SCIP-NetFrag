...
def run_start_time():
    ...
    x_labels = [str(t) for t in T_max_2_Array]
    solve_counter = 0

    run = BlockRun("start_time", config={
        ...
        "T_max_2_Array": T_max_2_Array,
        "addTime_factor": 0.6,
    }, axis={"x": XLEN_TAU_START, "y_fragments": YLEN_FRAG,
    ...
    run.save("plots/start_time_data.json", extra={"summary": summary,
                                                  "plot_files": [
        "plots/starttime_fragments.pdf",
        "plots/starttime_runtime.pdf",
    ]})
