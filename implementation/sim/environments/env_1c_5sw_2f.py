"""
env_1c_5sw_2f — light-load 1-cluster variant of env_1c_5sw_3f.

Same physical 5-switch / 1-cluster topology, but each worker carries only
...
def env_1c_5sw_2f(state):
    ...
    # Light load: 2 fragments per worker (vs 3 in env_1c_5sw_3f).
    fragmentsofEachWorker = {11: ["A0", "B0"], 22: ["A1", "B1"],
                             33: ["A2", "B2"], 44: ["A3", "B3"],
                             55: ["A4", "B4"], 66: ["A5", "B5"],
                             77: ["A6", "B6"], 88: ["A7", "B7"]}
