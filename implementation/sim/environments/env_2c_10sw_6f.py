"""
env_2c_10sw_6f — 2-cluster env, 6 frags/worker.

Same physical 10-switch / 2-cluster topology as env_2c_10sw_3f, with 6
fragments per worker (heavier than the baseline 3). Used by the
percentage-sweep block since the longer fragment lists produce a wider
dict_list, so rho-axis cells have more variation.
