"""
env_1c_5sw_3f_m3 — env_1c_5sw_3f with switch memory at level 3.

Identical to :mod:`env_1c_5sw_3f` in topology, ports, worker placement and
load; the *only* difference is ``numberSlotsSwitches``.
Aggregation/spine switches {1, 2, 4} carry three memory slots and the ToR
switches {0, 3} carry two.
...
def env_1c_5sw_3f_m3(state):
    ...
    numberSlotsSwitches = {0: [0, 1], 1: [0, 1, 2], 2: [0, 1, 2],
                           3: [0, 1], 4: [0, 1, 2]}
